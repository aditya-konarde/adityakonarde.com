...
- **Kubernetes 1.36 now available on managed services** -- Cloud providers including Oracle OKE catching up to the April upstream release, bringing DRA, Workload-Aware Scheduling, and fine-grained kubelet auth to managed clusters. [TFiR](https://tfir.io/kubernetes-1-36-gpu-scheduling-dra-kubelet-security/)
