...
[Source](https://mistral.ai/news/mistral-medium-3-5)
...
[Source](https://openai.com/index/openai-deployment-company/)
...
Tekton, the Kubernetes-native CI/CD framework, officially moved from the Continuous Delivery Foundation to the CNCF as an incubating project. Tekton uses CRDs to define pipelines as first-class Kubernetes objects, and the move aligns it more closely with the ecosystem it was built for — alongside Argo CD, Helm, and Flux. Tekton Pipelines recently reached 1.0 stability, and Red Hat has been a leading contributor. For teams already standardized on Kubernetes, having CI/CD under the same foundation roof as the orchestrator itself simplifies governance and interoperability.
...
- **formae adds Kubernetes support**: Platform Engineering Labs' open-source IaC tool now manages K8s resources (EKS, AKS) natively, adds Helm integration, and ships a public plugin hub. [Source](https://itbrief.news/story/formae-adds-kubernetes-support-public-plugin-hub)
