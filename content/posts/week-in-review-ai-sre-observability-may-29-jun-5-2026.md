...
- **Holo3.1 computer-use models ship with quantized weights** -- Four sizes from 0.8B to 35B, with FP8/NVFP4/Q4 GGUF checkpoints for local inference. First release optimized for edge deployment. [Hugging Face](https://huggingface.co/collections/Hcompany/holo31-68563e6c8e5788ea1ee2fc47)
